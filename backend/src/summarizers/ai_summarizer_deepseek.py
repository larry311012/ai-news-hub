...
class AISummarizerWithDeepSeek:
    """
    Extended AI Summarizer with DeepSeek support
...
Keep the tone informative yet engaging, suitable for social media."""
    ...
    def _call_deepseek(self, prompt: str) -> str:
        ...
        Raises:
            DeepSeek exceptions (will be caught and mapped by _call_llm)
        """
    ...
    def _handle_deepseek_error(self, error: Exception, context: Dict) -> AIProviderError:
        ...
        if isinstance(error, DeepSeekAuthenticationError):
            return AIProviderError(
                ...
                message="Invalid DeepSeek API key. Please check your API key in Profile settings.",
            ...
            return AIProviderError(
                ...
                message=f"DeepSeek rate limit exceeded. Retry after {retry_after}s" if retry_after else "DeepSeek rate limit exceeded",
